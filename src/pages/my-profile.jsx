        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              margin: '0 0 10px 0',
              textAlign: 'left',
            }}>{profile.major || "Your Major"} - Class of {profile.graduationYear || "Year"}</p>
            {isEditing ? (
              <select
          ...
          <div key={arrayField} style={{
            ...
            {isEditing ? (
              <div>
                <input
                  type="text"
                  onKeyPress={(e) => handleKeyPress(e, arrayField)}
                  placeholder={`Type and press Enter to add ${arrayField === 'skills' ? 'a skill' : 'an interest'}`}
                  style={{
                    padding: '8px 12px',
                    borderRadius: '20px',
                    border: 'none',
                ...
                <div style={{
                  ...
                  {editedProfile[arrayField].map((item, index) => (
